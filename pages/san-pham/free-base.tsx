...
const FreeBase = () => {
  ...
  return (
    <Layout>
      <section className=" mt-[75px] w-full flex justify-center items-center h-full bg-gray-100 pb-10">
        <div className="flex justify-center w-[80rem]">
          <div className="grow-0">
            <SideBar />
          </div>
          <div className="grow-[1]">
            <div className="mx-[49px] pl-3 py-2 mb-4 bg-white my-4 rounded">
            ...
            <SearchMenu />
            <div className="mx-[49px] bg-white pt-2 pb-5 rounded ">
              <div className="flex items-center justify-between mb-7 mt-3 px-4">
                <h1 className="font-medium text-xl border-l-4 border-red-400 pl-2">
                  Tinh dầu Freebase
                </h1>
                <div className="flex justify-between items-center gap-x-3">
                  <label className="font-semibold text-base">Sắp Xếp:</label>
                  <Select
                    options={options}
